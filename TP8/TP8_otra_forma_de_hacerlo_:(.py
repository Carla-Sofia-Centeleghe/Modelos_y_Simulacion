...
def ejecutar_simulacion():
    ...
    while tiempo_actual < segundos_apertura + 1800:
        ...
        if tiempos_atencion:
            ...
            draw_text(f"Tiempo mínimo de espera en salón: {(tiempo_min_espera_sala):.2f} s", (20, 170))
            draw_text(f"Tiempo máximo de atención en salon: {(tiempo_max_espera_sala):.2f} s", (20, 200))

        if tiempos_espera:
            draw_text(f"Tiempo mínimo de espera en salón: {tiempo_min_espera_sala:.2f} s", (20, 230))
            draw_text(f"Tiempo máximo de espera en salón: {tiempo_max_espera_sala:.2f} s", (20, 260))
    ...
    resultados_simulacion['tiempo_min_espera_sala'] = tiempo_min_espera_sala
    resultados_simulacion['tiempo_max_espera_sala'] = tiempo_max_espera_sala
